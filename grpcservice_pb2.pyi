...
class ModelInfoResponse(_message.Message):
    ...
    input_width: int
    input_channels: int
    def __init__(self, modelAuthor: _Optional[str] = ..., output_names: _Optional[_Iterable[str]] = ..., input_names: _Optional[str] = ..., input_height: _Optional[int] = ..., input_width: _Optional[int] = ..., input_channels: _Optional[int] = ...) -> None: ...
